...
const BROWNS_DATA = {
  ...
  2008: {
    ...
    WR: [
      ...
      { name: "Joshua Cribbs", stats: "47 rec, 562 yds as WR. Elite return specialist who lined up at receiver." },
    ],
    TE: [
  ...
  2010: {
    QB: [
      ...
      { name: "Jake Delhomme", stats: "390 yds, 3 TD, 4 INT, 67.6 passer rating in 2 starts. Signed as veteran stopgap, never got traction." },
    ],
    RB: [
...
export default function DawgPoundDraft() {
  ...
  useEffect(() => {
    ...
    const enterTimer = setTimeout(() => {
      ...
      const doTick = () => {
        ...
        tick++;
        const nextDelay = tick < 8 ? 80 : tick < 16 ? 130 : 210;
  ...
  // Injury flash animation
  useEffect(() => {
    if (phase !== "injury") return;
    let count = 0;
          ...
          <div style={{ position: "fixed", inset: 0, background: "#050302", zIndex: 9999,
            ...
            {(leAnimPhase === "spin" || leAnimPhase === "reveal") && (
              <div style={{ maxWidth: 360, width: "100%" }}>
                <div style={{
                  background: "#0d0a08",
                  border: `1px solid ${leAnimPhase === "reveal" ? (lakeEffect.winMod > 0 ? "#4a7a30" : "#8a2020") : "#2a3a5a"}`,
                  borderRadius: 10, padding: "20px 16px", transition: "border-color 0.4s",
                }}>
                  <div style={{
                    fontSize: leAnimPhase === "reveal" ? 15 : 13,
                    fontWeight: 700,
                    color: leAnimPhase === "reveal" ? "#e0c090" : "#5a7aaa",
